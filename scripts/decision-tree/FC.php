...
// 2. lihat aturan pada rule base
    ...
    while ($row= $ruledata->fetch_assoc()) {
        ...
        if ($ada==$jumlahfakta)
        {
           ...
           VALUES ($case_id, '$goalstt', $rule_id, '$then_part', $matchvalue, '$cocok', $user_id)";
    ...
    if ($simpan==0 and $prob==1)
    {
        // simpan data inferensi
        $sql = "INSERT INTO $tabelinferensi (case_id, case_goal, rule_id, rule_goal, match_value, cocok, user_id)
        VALUES ($case_id, '$goalstt', $rule_id_ok, '$then_part_ok', $matchvalue, $cocok_ok, $user_id)";
    ...
    { 
        // simpan data inferensi
        $sql = "INSERT INTO $tabelinferensi (case_id, case_goal, rule_id, rule_goal, match_value, cocok, user_id)
        VALUES ($case_id, '$goalstt', '', '', 0, 0, $user_id)";
